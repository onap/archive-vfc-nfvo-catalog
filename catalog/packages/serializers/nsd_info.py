...
class NsdInfoSerializer(serializers.Serializer):
    ...
    nsdId = serializers.CharField(
        ...
        It is copied from the NSD content and shall be present after the NSD content is on-boarded.',
        required=False,
        allow_null=True,
        allow_blank=True
    )
    nsdName = serializers.CharField(
        ...
        This information is copied from the NSD content and shall be present after the NSD content is on-boarded.',
        required=False,
        allow_null=True,
        allow_blank=True
    )
    ...
    vnfPkgIds = serializers.ListSerializer(
        help_text='Identifies the VNF package for the VNFD referenced by the on-boarded NS descriptor resource.',
        child=serializers.CharField(help_text="Identifier of the VNF package", allow_blank=True),
        required=False,
        allow_null=True,
        allow_empty=True
    )
    pnfdInfoIds = serializers.ListSerializer(
        help_text='Identifies the PnfdInfo element for the PNFD referenced by the on-boarded NS descriptor resource.',
        child=serializers.CharField(help_text="Identifier of the PnfdInfo element", allow_blank=True),
        required=False,
        allow_null=True,
        allow_empty=True
    )
    nestedNsdInfoIds = serializers.ListSerializer(
        help_text='Identifies the NsdInfo element for the nested NSD referenced by the on-boarded NS descriptor resource.',
        child=serializers.CharField(help_text="Identifier of the NsdInfo element", allow_blank=True),
        required=False,
        allow_null=True,
        allow_empty=True
    )
    ...
    onboardingFailureDetails = ProblemDetailsSerializer(
        ...
        It shall be present when the "nsdOnboardingState" attribute is CREATED and the uploading or processing fails in NFVO.',
        required=False,
        allow_null=True,
    )
