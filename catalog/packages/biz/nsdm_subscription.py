...
class NsdmSubscription:
    ...
    def check_valid_auth_info(self):
        ...
        if self.authentication.get("paramsOauth2ClientCredentials", {}) and \
            ...
            raise NsdmBadRequestException('Auth type should be '
        ...
        if const.BASIC in self.authentication.get("authType", '') and \
            ...
            raise NsdmBadRequestException('userName and password needed for '
                                          + const.BASIC)
    ...
    def save_db(self):
        ...
        links = {
            "self": {
                "href": const.NSDM_SUBSCRIPTION_ROOT_URI
