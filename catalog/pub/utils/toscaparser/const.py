...
NS_METADATA = (NS_UUID, NS_INVARIANTUUID, NS_NAME, NS_VERSION, NS_DESIGNER, NS_DESCRIPTION) =\
    ("id", "invariant_id", "name", "version", "designer", "description")

PNF_METADATA = (PNF_UUID, PNF_INVARIANTUUID, PNF_NAME, PNF_DESCRIPTION, PNF_VERSION, PNF_PROVIDER) = \
